# hrc_collision_monitor

This package is a copy of the nav2_collision_monitor for jazzy.

It adds some parameters for managing the polygons.

## New configuration

### Polygon

A new polygon action type is added: `source`

This action type allows to define a polygon relative to the `source_base_frame_id` parameter.
If a source point is outside this polygon, the points are ignored.

### Collision Monitor

|       Parameter        |  Type  | Default value | Unit |                        Description                        |
|:----------------------:|:------:|:-------------:|:----:|:---------------------------------------------------------:|
| `source_base_frame_id` | string |      map      | N/A  | The frame_id where the source polygon points are defined. |
