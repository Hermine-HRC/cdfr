...
#ifndef HRC_REGULATED_PURE_PURSUIT_CONTROLLER__REGULATED_PURE_PURSUIT_CONTROLLER_HPP_
#define HRC_REGULATED_PURE_PURSUIT_CONTROLLER__REGULATED_PURE_PURSUIT_CONTROLLER_HPP_
...
#include "hrc_regulated_pure_pursuit_controller/path_handler.hpp"
#include "hrc_regulated_pure_pursuit_controller/collision_checker.hpp"
#include "hrc_regulated_pure_pursuit_controller/parameter_handler.hpp"
#include "hrc_regulated_pure_pursuit_controller/regulation_functions.hpp"

namespace hrc_regulated_pure_pursuit_controller
{
...
protected:
   ...
   * @param final_heading Whether the robot is at the final position
   * and just have to rotate for reaching the goal position
   */
  void rotateToHeading(
    double & linear_vel, double & angular_vel,
    const double & angle_to_path, const geometry_msgs::msg::Twist & curr_speed,
    const bool final_heading = true);
  ...
  std::unique_ptr<hrc_regulated_pure_pursuit_controller::PathHandler> path_handler_;
  std::unique_ptr<hrc_regulated_pure_pursuit_controller::ParameterHandler> param_handler_;
  std::unique_ptr<hrc_regulated_pure_pursuit_controller::CollisionChecker> collision_checker_;
};

}  // namespace hrc_regulated_pure_pursuit_controller

#endif  // HRC_REGULATED_PURE_PURSUIT_CONTROLLER__REGULATED_PURE_PURSUIT_CONTROLLER_HPP_
