...
def generate_launch_description():
    ...
    pkg_hardware = FindPackageShare(package="herminebot_hardware").find("herminebot_hardware")
    ...
    start_hardware = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(pkg_hardware, "launch", "hardware.launch.py")),
        launch_arguments={'use_sim_time': 'false'}.items(),
    )

    start_nav = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(pkg_nav, "launch", "navigation.launch.py")),
        launch_arguments={"map": world_color, 'use_sim_time': 'false'}.items(),
